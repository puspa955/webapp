      ...
      <div className='flex justify-center items-center gap-12 text-gray-500 text-sm text-justify'>
        <div>
          <motion.p
            ...
            Even though Nepal poses so much potential for tourism, the information related to the tourist destinations of Nepal is not
            well organized. An individual has to go through a lot of websites to
            gain proper insights into the place they want to visit in Nepal. To bridge this gap, our enthusiastic team has developed a solution.
          </motion.p>
          ...
          <motion.p
            ...
            Here, we present <span className='font-bold'>GPTNepal</span>, which is a QA web app for tourists who want to visit Nepal and are looking for insights for the places
            they want to visit in Nepal. They can gain information for the places they want to visit at one location, i.e., at our web app.
            We have built our web app using the latest cutting edge technology called <span className='font-bold'>transformers</span>, which is primarily built for NLP
